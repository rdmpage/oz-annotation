...
class BBox
{
	...
	//------------------------------------------------------------------------------------
	function toBoundingPoly($w = 1, $h = 1)
	{
		$vertices = array();
		
		$topleft = new stdclass;
		$topleft->x = $this->minx/$w;
		$topleft->y = $this->miny/$h;
		
		$vertices[] = $topleft;

		$topright = new stdclass;
		$topright->x = $this->maxx/$w;
		$topright->y = $this->miny/$h;
		
		$vertices[] = $topright;
	
		$bottomright = new stdclass;
		$bottomright->x = $this->maxx/$w;
		$bottomright->y = $this->maxy/$h;
		
		$vertices[] = $bottomright;

		$bottomleft = new stdclass;
		$bottomleft->x = $this->minx/$w;
		$bottomleft->y = $this->maxy/$h;
